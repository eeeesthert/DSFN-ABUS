...
#             print('boundary_loss:{}'.format(boundary_loss))
            ...
            total_loss = boundary_loss + smooth2_loss + 0.1*depth_diff_loss + smooth1_loss 
...
if __name__=="__main__":
    ...
    parser.add_argument('--train_path', type=str, default='~/wwmt_tdsc/simulated/dsfn_warp_cv/fold0/train')
