...
class TrainDataset(Dataset):
    def __init__(self, data_path):
        ...
        # expected folders:
        # input1, input2, input3, nippleHeatmap1, nippleHeatmap2, nippleHeatmap3
        valid_folders = (
    ...
    def __getitem__(self, index):
        ...
        heat1 = self._load_heatmap(self.datas["nippleHeatmap1"]["image"][index])
        heat2 = self._load_heatmap(self.datas["nippleHeatmap2"]["image"][index])
        heat3 = self._load_heatmap(self.datas["nippleHeatmap3"]["image"][index])
...
class TestDepthOutDataset(Dataset):
    def __init__(self, data_path):
        ...
        valid = ("input1", "input2", "nippleHeatmap1", "nippleHeatmap2")
        for data in sorted(glob.glob(os.path.join(self.test_path, '*'))):
            data_name = os.path.basename(data)
