...
def test(args):
    ...
    print("##################end testing#######################")
    print("psnr.max = {:.6f}, psnr.min = {:.6f}, psnr.max.index = {}, psnr.min.index = {}".format(psnrmax, psnrmin, psnrmaxIndex, psnrminIndex))
    print("ssim.max = {:.6f}, ssim.min = {:.6f}, ssim.max.index = {}, ssim.min.index = {}".format(ssimmax, ssimmin, ssimmaxIndex, ssimminIndex))
